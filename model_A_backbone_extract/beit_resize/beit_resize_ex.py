...
MODEL_DIR = "./models/beit_resize"
CSV_PATH = "./cx.csv"
FEATURE_DIR = "./features/beit_resize_features"
NUM_RUNS = 30
...
for run in range(NUM_RUNS):
    ...
    if features:
        ...
        save_path = os.path.join(FEATURE_DIR, f"beit_resize_backbone_features_run{run}.csv")
...
dfs = []
for run in range(NUM_RUNS):
    file_path = os.path.join(FEATURE_DIR, f"beit_resize_backbone_features_run{run}.csv")
...
if dfs:
    ...
    merged_path = os.path.join(FEATURE_DIR, "beit_resize_backbone_features_merged.csv")
