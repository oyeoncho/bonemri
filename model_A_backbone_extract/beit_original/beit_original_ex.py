...
# 설정
CACHE_DIR = "./slice_cache_224_resize"
MODEL_DIR = "./models/beit_original"
CSV_PATH = "./cx.csv"
FEATURE_DIR = "./features/beit_original_features"
NUM_RUNS = 30
...
for run in range(NUM_RUNS):
    ...
    if features:
        ...
        save_path = os.path.join(FEATURE_DIR, f"beit_original_backbone_features_run{run}.csv")
...
dfs = []
for run in range(NUM_RUNS):
    file_path = os.path.join(FEATURE_DIR, f"beit_original_backbone_features_run{run}.csv")
...
if dfs:
    ...
    merged_path = os.path.join(FEATURE_DIR, "beit_original_backbone_features_merged.csv")
